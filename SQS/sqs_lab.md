...
- ✅ Appropriate AWS IAM permissions for SQS operations
...
# aws_sqs_queue.order_notifications will be created
...
# aws_sqs_queue.order_notifications_dlq will be created
...

# aws_sqs_queue.payment_processing will be created
...

# aws_sqs_queue.payment_processing_dlq will be created
...
```
...
When prompted, type `yes` to confirm, or use:
...
**Expected Output:**
```
aws_sqs_queue.order_notifications_dlq: Creating...
aws_sqs_queue.payment_processing_dlq: Creating...
aws_sqs_queue.payment_processing_dlq: Creation complete after 27s
aws_sqs_queue.order_notifications_dlq: Creation complete after 27s
aws_sqs_queue.payment_processing: Creating...
aws_sqs_queue.order_notifications: Creating...
aws_sqs_queue.order_notifications: Creation complete after 26s
aws_sqs_queue.payment_processing: Creation complete after 26s

Apply complete! Resources: 4 added, 0 changed, 0 destroyed.

Outputs:

order_notifications_dlq_url = "https://sqs.us-east-1.amazonaws.com/ACCOUNT/order-notifications-dlq"
order_notifications_queue_arn = "arn:aws:sqs:us-east-1:ACCOUNT:order-notifications-queue"
order_notifications_queue_url = "https://sqs.us-east-1.amazonaws.com/ACCOUNT/order-notifications-queue"
payment_processing_dlq_url = "https://sqs.us-east-1.amazonaws.com/ACCOUNT/payment-processing-dlq.fifo"
payment_processing_queue_arn = "arn:aws:sqs:us-east-1:ACCOUNT:payment-processing-queue.fifo"
payment_processing_queue_url = "https://sqs.us-east-1.amazonaws.com/ACCOUNT/payment-processing-queue.fifo"
```

**Save the Queue URLs** - You'll need these for testing. Export them as environment variables:

```bash
export STANDARD_QUEUE_URL=$(terraform output -raw order_notifications_queue_url)
export FIFO_QUEUE_URL=$(terraform output -raw payment_processing_queue_url)
...
📨 Processing message from Standard Queue (Order Notifications):
   Message ID: b34c4922-cb5f-4d4a-afeb-ff63459f9a86
   Receipt Handle: AQEBF3ByUxBCpXUvuPzuMp8vkq6veBN6dDpacUCxj/JUWA7Tf2...
   Body: {
  "order_id": "ORD-002",
  "customer_email": "customer2@example.com",
  "order_total": 149.5,
  "timestamp": "2025-11-20T16:46:37.131868",
  "type": "order_notification"
}
   Attributes: {'OrderTotal': {'StringValue': '149.5', 'DataType': 'Number'}, 'OrderType': {'StringValue': 'standard', 'DataType': 'String'}}
   ✅ Message processed successfully!
   🗑️  Message deleted from queue
...
**Expected Output:**
```
aws_sqs_queue.order_notifications: Refreshing state...
aws_sqs_queue.payment_processing: Refreshing state...
aws_sqs_queue.order_notifications_dlq: Refreshing state...
aws_sqs_queue.payment_processing_dlq: Refreshing state...

Plan: 0 to add, 0 to change, 4 to destroy.

aws_sqs_queue.order_notifications: Destroying...
aws_sqs_queue.payment_processing: Destroying...
aws_sqs_queue.order_notifications_dlq: Destroying...
aws_sqs_queue.payment_processing_dlq: Destroying...
aws_sqs_queue.order_notifications: Destruction complete after 1s
aws_sqs_queue.payment_processing: Destruction complete after 1s
aws_sqs_queue.order_notifications_dlq: Destruction complete after 1s
aws_sqs_queue.payment_processing_dlq: Destruction complete after 1s
